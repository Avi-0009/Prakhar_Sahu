...
{
    /// <summary>The summary exceeded what the store can hold.</summary>
    public static Error SummaryTooLong(int maximum) => new(
        "work_order.summary_too_long",
        $"A summary must be {maximum} characters or fewer.");
