...
public class AsyncFlowTests
{
    ...
    private sealed class System
    {
        public System()
        {
            ...
            // The success reply. Published since day one, subscribed to as of Day 30 -- before
            // this the confirmation went nowhere and nothing could tell a real booking from one
            // still in flight.
